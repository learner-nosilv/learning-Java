 ...
 * [Main] PayService.processPay 종료
 *
 * 3. DI 진행시, null을 다루지 않는 방향으로 변경 Null object pattern
 * [Main] 결제 수단을 입력하세요: asdf
 * [Main] 결제 금액을 입력하세요: 1000
 * [Main] PayService.processPay 실행
 * [PayService.processPay] 결제를 시작합니다: option=asdf, amount=1000
 * [PayService.processPay] Dependency Injection: Pay pay = PayStore.findPay(option);
 * [NullPay.pay] 유효한 결제수단이 아닙니다.
 * [PayService.processPay] 결제가 실패했습니다.
 * [Main] PayService.processPay 종료
 */